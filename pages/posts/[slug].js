  ...
  return (
    <>
      ...
      <main className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-3xl bg-white p-8 rounded-lg shadow-md border-t-8 border-blue-500">
          ...
          <section className="mt-12 p-6 bg-blue-50 rounded-lg text-center shadow-inner border border-blue-200">
      ...
      <footer className="bg-gray-900 text-white py-8 text-center border-t border-gray-700">
        <div className="container mx-auto flex flex-wrap justify-center items-center gap-4 px-4">
          <nav className="footer-nav flex justify-center gap-4 mb-4 w-full">
            ...
            <Link href={"/posts/" + postData.slug} className="text-gray-400 hover:text-white text-sm transition-colors duration-200">
