      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="p-8 bg-white bg-opacity-10 rounded-xl shadow-xl border-b-8 border-purple-400 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <a href={YOUR_ADVANCED_COURSE_LINK} className="text-purple-400 hover:text-white font-bold mt-4 inline-block text-lg underline">
                  اطلاعات بیشتر →
                </a>
              </div>
            </div>
        ...
        <section className="py-16 bg-blue-700 text-white text-center">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="bg-white text-gray-900 p-8 rounded-lg shadow-xl border-t-xl">
        ...
        <section className="bg-gradient-to-br from-green-700 to-teal-800 py-20 text-white text-center relative overflow-hidden">
          ...
          {/* <div className="absolute inset-0 z-0 opacity-30" style="background-image: url('/images/abstract-pattern-green.svg'); background-repeat: repeat;"></div> */}
          <div className="container mx-auto px-4 relative z-10">
            <h2 className="text-5xl md:text-6xl font-extrabold text-white mb-8 leading-tight animate-pulse-fomo drop-shadow-xl">
              <span className="text-yellow-400">یک تصمیم نهایی.</span> <br className="md:hidden" /> یک عمر پشیمانی، یا <span className="text-yellow-400">آزادی مالی؟</span>
            </h2>
            ...
            <a href={YOUR_IRANIAN_PLATFORM_PRODUCT_LINK} className="download-button bg-blue-600 text-white py-3 px-6 text-xl font-bold rounded-lg hover:bg-blue-700 transition-all duration-300 inline-block shadow-xl transform hover:scale-105">
              <span className="animate-pulse">بله! می‌خوام هر ماه سود بکنم! همین الان شروع کن</span>
            </a>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="pb-10">
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                با دانلود <strong>نقشه راه رایگان</strong> ما، اولین قدم‌های خود را بدون هیچ ریسک و تعهدی بردارید و با مفاهیم پایه ساختار بازار آشنا شدید. <span className="font-semibold">حتی این چک لیست هم می‌تواند دیدگاه شما را تغییر دهد!</span>
              </p>
              <a href={YOUR_GUMROAD_FREE_PRODUCT_LINK_FOR_FARSI_CHECKLIST} className="bg-blue-500 text-white py-3 px-6 rounded-lg text-xl font-bold hover:bg-blue-600 transition-all duration-300 inline-block no-underline">
                دانلود نقشه راه رایگان (چک لیست)
              </a>
            </div>
          </div>
        ...
        <footer className="bg-gray-900 text-white py-8 text-center border-t border-gray-700">
          <div className="container mx-auto justify-center flex flex-wrap items-center-20 gap-4>
            <nav className="footer-nav flex justify-center gap-4 mb-4 w-full">
              <Link href="/privacy" className="text-gray-400 hover:text-white text-sm transition-colors duration-300">">سیاست حریم خصوصی</Link>
              <a href={YOUR_IRANIAN_PLATFORM_PRODUCT_LINK} className="text-gray-400 hover:text-white text-sm transition-colors duration-300">">
                مشاهده استراتژی کامل در [نام پلتفرم]
              </a>
            </nav>
            <p className="copyright text-gray-400 text-xs w-full">
              &copy; {CURRENT_YEAR}. {YOUR_NAME_OR_BRAND_NAME}. تمام حقوق محفوظ است.
            </p>
          </div>
        </footer>
      </main>
